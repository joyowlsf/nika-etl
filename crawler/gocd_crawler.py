...
def main():
    for i in range(10):
        url = "https://cafe.naver.com/casuallydressed?iframe_url=/ArticleList.nhn%3Fsearch.clubid=19943558%26search.menuid=79%26search.boardtype=I%26search.totalCount=201%26search.cafeId=19943558%26search.page={}".format(i+1)
